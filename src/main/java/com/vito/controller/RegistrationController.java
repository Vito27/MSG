...
import com.vito.model.dto.CaptchaResponseDto;
import com.vito.service.UserService;
...
public class RegistrationController {
    ...
    public String addUser(
            @RequestParam("secondPassword") String passwordConfirm,
        ...
        if(isConfirmEmpty){
            model.addAttribute("secondPassword", "Password confirmation cannot be empty");
        }
